...
const demoPatients = [
  {
    ...
    age: 45,
    gender: "male",
    contact: { phone: "+91 99887 76655", email: "rajesh.k@email.com" },
  ...
  },
  {
    ...
    age: 62,
    gender: "female",
    contact: { phone: "+91 99887 76656", email: "sunita.d@email.com" },
    address: "456 Park Road, Sector 14",
    bloodGroup: "O+",
    allergies: [],
  ...
  },
  {
    ...
    age: 28,
    gender: "male",
    contact: { phone: "+91 99887 76657", email: "amit.s@email.com" },
    address: "789 Lake View, Sector 8",
    bloodGroup: "A+",
  ...
  },
  {
    ...
    age: 35,
    gender: "female",
    contact: { phone: "+91 99887 76658", email: "priya.g@email.com" },
    address: "321 Hill Side, Sector 5",
    bloodGroup: "AB+",
    allergies: [],
  ...
  },
  {
    ...
    age: 55,
    gender: "male",
    contact: { phone: "+91 99887 76659", email: "ravi.v@email.com" },
    address: "654 Green Park, Sector 11",
    bloodGroup: "B-",
    allergies: ["Aspirin"],
  ...
  },
  {
    ...
    age: 42,
    gender: "female",
    contact: { phone: "+91 99887 76660", email: "anita.s@email.com" },
    address: "987 Rose Garden, Sector 9",
    bloodGroup: "O-",
    allergies: [],
  ...
  },
  {
    ...
    age: 70,
    gender: "male",
    contact: { phone: "+91 99887 76661", email: "vikram.p@email.com" },
    address: "246 Temple Road, Sector 3",
    bloodGroup: "A-",
    allergies: ["Ibuprofen"],
    medicalHistory: ["Heart Disease", "Diabetes Type 2"],
    facilityId: "PHC-001",
  ...
  },
  {
    ...
    age: 31,
    gender: "female",
    contact: { phone: "+91 99887 76662", email: "meera.r@email.com" },
    address: "135 River Side, Sector 7",
    bloodGroup: "AB-",
    allergies: [],
    medicalHistory: [],
    facilityId: "PHC-001",
  ...
  },
  {
    ...
    age: 8,
    gender: "male",
    contact: { phone: "+91 99887 76663", email: "parent.arjun@email.com" },
    address: "567 School Lane, Sector 15",
    bloodGroup: "O+",
    allergies: ["Peanuts"],
  ...
  },
  {
    ...
    age: 29,
    gender: "female",
    contact: { phone: "+91 99887 76664", email: "kavita.j@email.com" },
    address: "890 Market Street, Sector 6",
    bloodGroup: "B+",
    allergies: [],
    medicalHistory: [],
    isPregnant: true,
  ...
  },
  {
    ...
    age: 48,
    gender: "male",
    contact: { phone: "+91 99887 76665", email: "khan.m@email.com" },
    address: "432 Station Road, Sector 10",
    bloodGroup: "A+",
    allergies: [],
  ...
  },
  {
    ...
    age: 56,
    gender: "female",
    contact: { phone: "+91 99887 76666", email: "lakshmi.n@email.com" },
    address: "765 Beach Road, Sector 2",
    bloodGroup: "O+",
    allergies: ["Morphine"],
    medicalHistory: ["Breast Cancer - Survivor"],
    facilityId: "PHC-001",
    createdAt: new Date(),
  },
  {
    _id: "patient-013",
    patientId: "PT-2026-00013",
    name: "Baby Aanya",
    age: 2,
    gender: "female",
    contact: { phone: "+91 99887 76667", email: "parent.aanya@email.com" },
    address: "111 Garden View, Sector 4",
    bloodGroup: "B+",
    allergies: [],
    medicalHistory: [],
    isPediatric: true,
  ...
  {
    _id: "patient-014",
    patientId: "PT-2026-00014",
    name: "Suresh Iyer",
    age: 67,
    gender: "male",
    contact: { phone: "+91 99887 76668", email: "suresh.i@email.com" },
    address: "222 Temple Street, Sector 1",
    bloodGroup: "AB+",
    allergies: ["Codeine"],
  ...
  },
  {
    ...
    age: 24,
    gender: "female",
    contact: { phone: "+91 99887 76669", email: "neha.k@email.com" },
    address: "333 College Road, Sector 13",
    bloodGroup: "A-",
    allergies: [],
    medicalHistory: ["Anxiety", "PCOS"],
    facilityId: "PHC-001",
    createdAt: new Date(),
  },
  // NEW PATIENTS - Women's Health, Critical Conditions, Diverse Diseases
  {
    ...
    age: 32,
    gender: "female",
    contact: { phone: "+91 99887 76670", email: "deepika.m@email.com" },
    address: "444 MG Road, Sector 18",
    bloodGroup: "O+",
    allergies: [],
  ...
  },
  {
    ...
    age: 26,
    gender: "female",
    contact: { phone: "+91 99887 76671", email: "rashmi.p@email.com" },
    address: "555 Lake Road, Sector 19",
    bloodGroup: "B+",
    allergies: ["Latex"],
    medicalHistory: ["Dysmenorrhea", "Iron Deficiency Anemia"],
    menstrualInfo: {
      lastPeriod: new Date(Date.now() - 45 * 24 * 60 * 60 * 1000),
      cycleLength: 28,
      regularCycle: false,
    },
    facilityId: "PHC-001",
  ...
  },
  {
    ...
    age: 38,
    gender: "female",
    contact: { phone: "+91 99887 76672", email: "fatima.b@email.com" },
    address: "666 Station Lane, Sector 20",
    bloodGroup: "A+",
    allergies: [],
    medicalHistory: ["Gestational Diabetes", "Previous C-Section"],
    isPregnant: true,
    pregnancyWeeks: 34,
    facilityId: "PHC-001",
    createdAt: new Date(),
  },
  {
    ...
    age: 52,
    gender: "male",
    contact: { phone: "+91 99887 76673", email: "sanjay.a@email.com" },
    address: "777 Industrial Area, Sector 21",
    bloodGroup: "AB+",
    allergies: ["Contrast dye"],
    medicalHistory: [
      "Coronary Artery Disease",
      "Stent placement 2024",
      "Hyperlipidemia",
    ],
    facilityId: "PHC-001",
    createdAt: new Date(),
  },
  {
    ...
    age: 19,
    gender: "female",
    contact: { phone: "+91 99887 76674", email: "pooja.s@email.com" },
    address: "888 University Road, Sector 22",
    bloodGroup: "O-",
    allergies: [],
    medicalHistory: ["PCOS", "Acne"],
    menstrualInfo: {
      lastPeriod: new Date(Date.now() - 60 * 24 * 60 * 60 * 1000),
      cycleLength: 45,
      regularCycle: false,
      heavyBleeding: true,
    },
  ...
  {
    _id: "patient-021",
    patientId: "PT-2026-00021",
    name: "Ramesh Choudhary",
    age: 58,
    gender: "male",
    contact: { phone: "+91 99887 76675", email: "ramesh.c@email.com" },
    address: "999 Old City, Sector 23",
    bloodGroup: "B-",
    allergies: ["Metformin"],
    medicalHistory: [
      "Type 2 Diabetes",
  ...
  },
  {
    ...
    age: 6,
    gender: "male",
    contact: { phone: "+91 99887 76676", email: "parent.rohan@email.com" },
    address: "101 School Colony, Sector 24",
    bloodGroup: "A+",
    allergies: ["Eggs", "Milk"],
    medicalHistory: ["Epilepsy", "Developmental Delay"],
    isPediatric: true,
    facilityId: "PHC-001",
    createdAt: new Date(),
  },
  {
    ...
    age: 48,
    gender: "female",
    contact: { phone: "+91 99887 76677", email: "geeta.r@email.com" },
    address: "202 Temple Colony, Sector 25",
    bloodGroup: "O+",
    allergies: [],
    medicalHistory: ["Perimenopause", "Osteoporosis", "Hypothyroid"],
    menstrualInfo: {
      lastPeriod: new Date(Date.now() - 90 * 24 * 60 * 60 * 1000),
      irregularBleeding: true,
      hotFlashes: true,
    },
    facilityId: "PHC-001",
    createdAt: new Date(),
  ...
  {
    _id: "patient-024",
    patientId: "PT-2026-00024",
    name: "Vinod Tiwari",
    age: 44,
    gender: "male",
    contact: { phone: "+91 99887 76678", email: "vinod.t@email.com" },
    address: "303 Civil Lines, Sector 26",
    bloodGroup: "AB-",
    allergies: [],
    medicalHistory: ["Chronic Hepatitis B", "Liver Cirrhosis"],
    facilityId: "PHC-001",
    createdAt: new Date(),
  },
  {
    ...
    age: 27,
    gender: "female",
    contact: { phone: "+91 99887 76679", email: "sneha.k@email.com" },
    address: "404 IT Park, Sector 27",
    bloodGroup: "B+",
    allergies: [],
    medicalHistory: ["Graves Disease", "Hyperthyroidism"],
    isPregnant: true,
    pregnancyWeeks: 12,
    facilityId: "PHC-001",
    createdAt: new Date(),
  },
  {
    ...
    age: 72,
    gender: "male",
    contact: { phone: "+91 99887 76680", email: "prakash.m@email.com" },
    address: "505 Retirement Home, Sector 28",
    bloodGroup: "A+",
    allergies: ["NSAIDs"],
    medicalHistory: [
  ...
  {
    _id: "patient-027",
    patientId: "PT-2026-00027",
    name: "Anjali Deshmukh",
    age: 33,
    gender: "female",
    contact: { phone: "+91 99887 76681", email: "anjali.d@email.com" },
    address: "606 Green Valley, Sector 29",
    bloodGroup: "O+",
    allergies: [],
    medicalHistory: ["Ectopic Pregnancy History", "Infertility"],
    menstrualInfo: {
      lastPeriod: new Date(Date.now() - 35 * 24 * 60 * 60 * 1000),
      cycleLength: 30,
      painfulPeriods: true,
    },
    facilityId: "PHC-001",
  ...
  },
  {
    ...
    age: 61,
    gender: "male",
    contact: { phone: "+91 99887 76682", email: "harish.b@email.com" },
    address: "707 Mall Road, Sector 30",
    bloodGroup: "B+",
    allergies: [],
    medicalHistory: ["Atrial Fibrillation", "On Warfarin", "Previous Stroke"],
    facilityId: "PHC-001",
    createdAt: new Date(),
  },
  {
    ...
    age: 41,
    gender: "female",
    contact: { phone: "+91 99887 76683", email: "rekha.v@email.com" },
    address: "808 Housing Board, Sector 31",
    bloodGroup: "A-",
    allergies: [],
    medicalHistory: ["Uterine Fibroids", "Menorrhagia"],
    menstrualInfo: {
  ...
  {
    _id: "patient-030",
    patientId: "PT-2026-00030",
    name: "Baby Ishaan",
    age: 4,
    gender: "male",
    contact: { phone: "+91 99887 76684", email: "parent.ishaan@email.com" },
    address: "909 Kids Colony, Sector 32",
    bloodGroup: "O+",
    allergies: ["Penicillin"],
    medicalHistory: ["Congenital Heart Defect", "VSD Repair 2024"],
    isPediatric: true,
    facilityId: "PHC-001",
    createdAt: new Date(),
  },
...
const demoAssessments = [
  {
    ...
    confidence: 0.87,
    recommendations: [
      "🔴 PRIORITY: Patient should be seen within 30 minutes",
  ...
  },
  {
    ...
    confidence: 0.85,
    recommendations: [
      "🟡 ELEVATED: Patient should be seen within 1 hour",
      "Antipyretic medication may help",
      "Hydration important",
      "📋 All findings must be verified by examining healthcare professional",
    ],
    assessedBy: "demo-user-003",
  ...
  },
  {
    ...
    isPediatric: true,
    recommendations: [
      "🔴 PEDIATRIC PRIORITY: Child needs immediate attention",
      "Nebulization may be required",
      "Monitor oxygen saturation closely",
      "Consider pediatric dosage medications",
      "📋 All findings must be verified by examining healthcare professional",
    ],
  ...
  },
  {
    ...
    pregnancyWeeks: 28,
    recommendations: [
      "🔴 OBSTETRIC PRIORITY: Pregnant patient needs attention",
  ...
  },
  {
    ...
    confidence: 0.91,
    recommendations: [
      "🚨 CRITICAL: Elderly patient with concerning vitals",
  ...
  },
  {
    ...
    recommendations: [
      ...
      "Renal function tests recommended",
    ...
    prescription:
      "Metformin 500mg BD, Lifestyle modifications, Follow-up in 1 week",
  ...
  // NEW ASSESSMENTS - Women's Health, Critical Conditions, Diverse Diseases
  {
    ...
    chiefComplaint:
      "Severe headache and visual disturbances - 36 weeks pregnant",
    symptoms: [
      "Severe headache",
      "Visual disturbances",
    ...
    highRiskPregnancy: true,
    recommendations: [
      "🚨 CRITICAL OBSTETRIC EMERGENCY: Suspected preeclampsia/eclampsia",
      "Immediate BP monitoring and IV access",
      "Magnesium sulfate protocol may be required",
  ...
  },
  {
    ...
    recommendations: [
      "🔴 PRIORITY: Heavy menstrual bleeding - check hemoglobin",
      "IV access for possible fluid resuscitation",
      "Pain management required",
      "Rule out ectopic pregnancy - pregnancy test",
  ...
  },
  {
    ...
    confidence: 0.98,
    recommendations: [
      "🚨 STEMI ALERT: Suspected acute myocardial infarction",
      "Immediate ECG - activate cath lab if available",
      "Aspirin 325mg STAT",
      "IV access and oxygen",
      "Nitroglycerin if BP permits",
      "Morphine for pain",
      "Emergency cardiology consultation",
      "Prepare for possible thrombolysis/PCI",
      "📋 All findings must be verified by examining healthcare professional",
    ],
    assessedBy: "demo-user-003",
    assessedByName: "Nurse Priya Sharma",
  ...
  },
  {
    ...
    isPediatric: true,
    recommendations: [
      "🚨 CRITICAL PEDIATRIC: Febrile seizure with meningeal signs",
      "Secure airway and monitor closely",
      "IV access - anticonvulsant ready",
      "Urgent lumbar puncture consideration",
  ...
  },
  {
    ...
    perimenopausal: true,
    recommendations: [
      "🟢 Perimenopausal symptoms - routine evaluation",
      "Thyroid function tests",
      "Pelvic ultrasound to rule out pathology",
      "Bone density screening recommended",
      "Discuss hormone replacement therapy options",
  ...
  },
  {
    ...
    confidence: 0.9,
    recommendations: [
      "🚨 CRITICAL: Acute decompensated heart failure with CKD",
      "Immediate oxygen and diuretics",
      "Strict fluid restriction",
      "Nephrology consultation - dialysis may be needed",
      "ECG and chest X-ray STAT",
      "BNP and renal function tests",
  ...
  },
  {
    ...
    symptoms: [
      "Menorrhagia - soaking pad every hour",
      "Large blood clots",
      "Severe cramping",
      "Lightheadedness",
      "Fatigue",
    ...
    menstrualRelated: true,
    recommendations: [
      "🔴 PRIORITY: Significant blood loss - check hemoglobin urgently",
      "IV access for fluid resuscitation if needed",
      "Tranexamic acid 1g TDS",
      "Iron supplementation",
      "Pelvic ultrasound for fibroids/polyps",
      "Consider hormonal management",
      "Gynecology referral - may need surgical intervention",
      "📋 All findings must be verified by examining healthcare professional",
    ],
    assessedBy: "demo-user-006",
    assessedByName: "Nurse Anita Roy",
  ...
  },
  {
    ...
    confidence: 0.89,
    recommendations: [
      "🚨 CRITICAL: Rapid AFib with hemodynamic instability",
      "Continuous cardiac monitoring",
      "Check INR - patient on Warfarin",
      "Rate control vs cardioversion decision needed",
      "Hold anticoagulation if procedure planned",
  ...
  },
  {
    ...
    symptoms: [
      ...
      "Previous C-section scar tenderness",
    ],
    riskLevel: "high",
    riskScore: 75,
    urgencyScore: 75,
    ...
    recommendations: [
      "🔴 OBSTETRIC PRIORITY: Reduced fetal movements in high-risk pregnancy",
      "Immediate NST/CTG monitoring",
      "Biophysical profile if NST non-reactive",
      "Blood glucose monitoring",
      "Assess C-section scar",
      "Obstetric team notification",
...
const demoQueue = [
  {
    ...
    facilityId: "PHC-001",
    addedAt: new Date(
      Date.now() - (15 + Math.floor(Math.random() * 8 - 4)) * 60 * 1000,
    ),
    createdAt: new Date(Date.now() - 15 * 60 * 1000),
  },
  {
    ...
    facilityId: "PHC-001",
    addedAt: new Date(
      Date.now() - (45 + Math.floor(Math.random() * 10 - 5)) * 60 * 1000,
    ),
  ...
  },
  {
    ...
    facilityId: "PHC-001",
    addedAt: new Date(
      Date.now() - (30 + Math.floor(Math.random() * 8 - 4)) * 60 * 1000,
    ),
    createdAt: new Date(Date.now() - 30 * 60 * 1000),
  },
  {
    ...
    facilityId: "PHC-001",
    addedAt: new Date(
      Date.now() - (20 + Math.floor(Math.random() * 6 - 3)) * 60 * 1000,
    ),
    createdAt: new Date(Date.now() - 20 * 60 * 1000),
  },
  {
    ...
    facilityId: "PHC-001",
    addedAt: new Date(
      Date.now() - (60 + Math.floor(Math.random() * 12 - 6)) * 60 * 1000,
    ),
  ...
  },
  {
    ...
    facilityId: "PHC-001",
    addedAt: new Date(
      Date.now() - (25 + Math.floor(Math.random() * 8 - 4)) * 60 * 1000,
    ),
    createdAt: new Date(Date.now() - 25 * 60 * 1000),
  },
  {
    ...
    facilityId: "PHC-001",
    addedAt: new Date(
      Date.now() - (10 + Math.floor(Math.random() * 4 - 2)) * 60 * 1000,
    ),
    createdAt: new Date(Date.now() - 10 * 60 * 1000),
  },
  {
  ...
  },
  {
    ...
    facilityId: "PHC-001",
    addedAt: new Date(
      Date.now() - (5 + Math.floor(Math.random() * 3)) * 60 * 1000,
    ),
    createdAt: new Date(Date.now() - 5 * 60 * 1000),
  },
    ...
    payments: [
      {
        ...
        method: "upi",
        amount: 1680,
        transactionId: "UPI2026012700001",
        upiId: "khan.m@paytm",
        paidAt: new Date(Date.now() - 30 * 60 * 1000),
        processedBy: "demo-user-004",
        processedByName: "Staff Amit Kumar",
      },
    ],
    emailHistory: [
      {
        email: "khan.m@email.com",
    ...
    payments: [
      {
        ...
        method: "card",
        amount: 1732,
        transactionId: "CRD2026012700002",
        cardLast4: "4242",
    ...
    payments: [
      {
        ...
        method: "cash",
        amount: 2000,
        transactionId: "CASH2026012700003",
        paidAt: new Date(Date.now() - 2 * 60 * 60 * 1000),
        processedBy: "demo-user-004",
        processedByName: "Staff Amit Kumar",
      },
    ...
    payments: [
      {
        ...
        method: "upi",
        amount: 2919,
        transactionId: "UPI2026012700004",
        upiId: "kavita.j@gpay",
    ...
    payments: [
      {
        ...
        method: "cash",
        amount: 1029,
        transactionId: "CASH2026012700005",
    ...
    payments: [
      {
        ...
        method: "upi",
        amount: 1890,
        transactionId: "UPI2026012700006",
        upiId: "meena.d@paytm",
    ...
    emailHistory: [
      {
        ...
        sentAt: new Date(Date.now() - 48 * 60 * 1000),
        status: "sent",
      },
    ],
    ...
    payments: [
      {
        ...
        method: "card",
        amount: 1500,
        transactionId: "CRD2026012700007",
        cardLast4: "8901",
        paidAt: new Date(Date.now() - 35 * 60 * 1000),
        processedBy: "demo-user-004",
        processedByName: "Staff Amit Kumar",
      },
    ],
    ...
    payments: [
      {
        ...
        method: "cash",
        amount: 683,
        transactionId: "CASH2026012700008",
...
const demoNotifications = [
  ...
  },
  {
    ...
    content:
      "You have a pending payment of ₹736. Please complete the payment at the billing counter.",
    billId: "bill-003",
    status: "sent",
...
export const demoStore = {
  ...
  patients: {
    findOne: (query) => {
      if (query.patientId)
        return patients.find((p) => p.patientId === query.patientId) || null;
    ...
    find: (query = {}) => {
      let result = [...patients];
      if (query.facilityId)
        result = result.filter((p) => p.facilityId === query.facilityId);
      return result;
    },
  ...
  assessments: {
    ...
    find: (query = {}) => {
      ...
      if (query.facilityId)
        result = result.filter((a) => a.facilityId === query.facilityId);
      if (query.riskLevel)
        result = result.filter((a) => a.riskLevel === query.riskLevel);
      return result.sort(
  ...
  queue: {
    findOne: (query) => {
      if (query.token)
        return queue.find((q) => q.token === query.token) || null;
    ...
    find: (query = {}) => {
      let result = [...queue];
      if (query.facilityId)
        result = result.filter((q) => q.facilityId === query.facilityId);
      if (query.status) {
        if (query.status.$in) {
  ...
  billing: {
    ...
    find: (query = {}) => {
      let result = [...billing];
      if (query.facilityId)
        result = result.filter((b) => b.facilityId === query.facilityId);
      if (query.patientId)
        result = result.filter((b) => b.patientId === query.patientId);
      if (query.status)
    ...
    addPayment: (id, paymentData) => {
      ...
      billing[index].amountPaid =
        (billing[index].amountPaid || 0) + paymentData.amount;
      billing[index].balanceDue =
        billing[index].totalAmount - billing[index].amountPaid;
      if (billing[index].balanceDue <= 0) {
        billing[index].status = "paid";
        billing[index].paidAt = new Date();
        billing[index].receiptNo =
          `RCP-2026-${String(billing.filter((b) => b.receiptNo).length + 1).padStart(5, "0")}`;
      } else {
    ...
    getStats: (facilityId) => {
      ...
      return {
        ...
        pendingAmount:
          pendingBills.reduce((sum, b) => sum + b.balanceDue, 0) +
          partialBills.reduce((sum, b) => sum + b.balanceDue, 0),
        todayRevenue: paidBills
          .filter(
            (b) =>
              new Date(b.paidAt).toDateString() === new Date().toDateString(),
          )
          .reduce((sum, b) => sum + b.totalAmount, 0),
        todayBills: facilityBills.filter(
          (b) =>
  ...
  notifications: {
    ...
    find: (query = {}) => {
      ...
      if (query.facilityId)
        result = result.filter((n) => n.facilityId === query.facilityId);
      if (query.recipientEmail)
        result = result.filter(
          (n) => n.recipientEmail === query.recipientEmail,
        );
      if (query.type) result = result.filter((n) => n.type === query.type);
      if (query.billId)
        result = result.filter((n) => n.billId === query.billId);
  ...
  getAnalytics: (facilityId) => {
    const facilityAssessments = assessments.filter(
    ...
    const todayAssessments = facilityAssessments.filter(
      (a) => new Date(a.createdAt) >= today,
    );
    const weekAssessments = facilityAssessments.filter(
      (a) => new Date(a.createdAt) >= thisWeek,
    );
    const waitingQueue = facilityQueue.filter((q) => q.status === "waiting");
    const completedQueue = facilityQueue.filter(
    ...
    const avgWaitTime =
      completedQueue.length > 0
        ? Math.round(
            completedQueue.reduce((sum, q) => sum + (q.waitTime || 12), 0) /
    ...
    return {
      overview: {
        ...
        criticalCases: facilityAssessments.filter(
          (a) => a.riskLevel === "critical",
        ).length,
        highRiskCases: facilityAssessments.filter((a) => a.riskLevel === "high")
          .length,
        queueLength: waitingQueue.length,
        avgWaitTime: avgWaitTime,
      },
      riskDistribution: {
        critical: facilityAssessments.filter((a) => a.riskLevel === "critical")
          .length,
        high: facilityAssessments.filter((a) => a.riskLevel === "high").length,
        medium: facilityAssessments.filter((a) => a.riskLevel === "medium")
          .length,
        low: facilityAssessments.filter((a) => a.riskLevel === "low").length,
      },
      queueStatus: {
        waiting: waitingQueue.length,
        inConsultation: facilityQueue.filter(
          (q) => q.status === "in-consultation",
        ).length,
